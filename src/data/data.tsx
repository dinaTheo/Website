  ...
  description: (
    <>
      ...
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a PhD Researcher based at the University of Bath, UK.  My background is in analytics/software engineering and physics and I love to work on data-driven apps with environmental impact, contributing to the common good. At my free time, I enjoy reading novels, non-fiction, and walking. I'm open to discuss collaboration opportunities. To get in touch with me, my email is <strong>kt918@bath.ac.uk</strong> and free feel to connect on LinkedIn.
      </p>
      {/* <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
